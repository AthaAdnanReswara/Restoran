        ...
        <div class="menu flex gap-8">
            ...
            @auth
                @if (auth()->user()->role === 'admin')
                    ...
                    <a href="{{ route('admin.pegawai.index') }}" class="nav-link py-2 px-4 transition"
                        data-menu="home">Pegawai</a>
                    <a href="{{ route('admin.menu.index') }}" class="nav-link py-2 px-4 transition"
                        data-menu="menu">Menu</a>
                @endif
